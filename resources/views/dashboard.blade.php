<x-app-layout>
    ...
    <div class="space-y-6 p-4 sm:p-6 lg:p-8">
        @php
            $dashboardCards = [
                ['label' => 'Total de PQRS', 'value' => $counts->total ?? 0, 'card' => 'border-indigo-200 bg-indigo-50', 'text' => 'text-indigo-700', 'iconBg' => 'bg-indigo-100 text-indigo-700', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l3.414 3.414A1 1 0 0117 7.414V19a2 2 0 01-2 2z', 'status' => null],
                ['label' => 'Radicadas', 'value' => $counts->radicadas ?? 0, 'card' => 'border-green-200 bg-green-50', 'text' => 'text-green-700', 'iconBg' => 'bg-green-100 text-green-700', 'icon' => 'M12 4v16m8-8H4', 'status' => 'radicada'],
                ['label' => 'En revisión', 'value' => $counts->en_revision ?? 0, 'card' => 'border-yellow-200 bg-yellow-50', 'text' => 'text-yellow-700', 'iconBg' => 'bg-yellow-100 text-yellow-700', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'status' => 'en_revision'],
                ['label' => 'En proceso', 'value' => $counts->en_proceso ?? 0, 'card' => 'border-violet-200 bg-violet-50', 'text' => 'text-violet-700', 'iconBg' => 'bg-violet-100 text-violet-700', 'icon' => 'M12 6v6l4 2', 'status' => 'en_proceso'],
                ['label' => 'En espera', 'value' => $counts->en_espera ?? 0, 'card' => 'border-amber-200 bg-amber-50', 'text' => 'text-amber-700', 'iconBg' => 'bg-amber-100 text-amber-700', 'icon' => 'M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'status' => 'en_espera'],
                ['label' => 'Rechazadas', 'value' => $counts->rechazadas ?? 0, 'card' => 'border-rose-200 bg-rose-50', 'text' => 'text-rose-700', 'iconBg' => 'bg-rose-100 text-rose-700', 'icon' => 'M6 18L18 6M6 6l12 12', 'status' => 'rechazada'],
                ['label' => 'Resueltas', 'value' => $counts->resueltas ?? 0, 'card' => 'border-orange-200 bg-orange-50', 'text' => 'text-orange-700', 'iconBg' => 'bg-orange-100 text-orange-700', 'icon' => 'M5 13l4 4L19 7', 'status' => 'resuelta'],
                ['label' => 'Cerradas', 'value' => $counts->cerradas ?? 0, 'card' => 'border-blue-200 bg-blue-50', 'text' => 'text-blue-700', 'iconBg' => 'bg-blue-100 text-blue-700', 'icon' => 'M5 13l4 4L19 7', 'status' => 'cerrada'],
            ];
        @endphp
