...
<div style="max-width:620px;margin:32px auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb">
    <div style="background:#1e3a5f;padding:24px;color:#fff"><h1 style="margin:0;font-size:20px">{{ $settings->residential_name }} · Gestión de PQRS</h1></div>
    <div style="padding:28px">
        <p>Hola, {{ $recipient->name }}.</p>
        <p>El estado de tu PQRS ha sido actualizado.</p>
