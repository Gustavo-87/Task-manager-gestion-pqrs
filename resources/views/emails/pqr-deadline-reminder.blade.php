...
<div style="max-width:620px;margin:32px auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb">
    ...
    <div style="padding:28px">
        ...
        <p>La PQRS <strong>#{{ $pqr->id }} {{ $timing }}</strong> y todavía requiere gestión.</p>
        ...
        <p style="color:#6b7280;font-size:13px">Este es un mensaje automático del sistema de gestión de PQRS.</p>
    </div>
</div></body></html>
